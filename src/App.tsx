  ...
  return (
    <div className="min-h-screen bg-sleek-bg text-slate-200 flex flex-col font-sans select-none overflow-x-hidden">
      ...
      <main className="flex-1 grid grid-cols-1 gap-px bg-sleek-border overflow-y-auto lg:overflow-auto">
        ...
        <aside className="border-t border-white/5 bg-black/30 flex flex-col p-4 sm:p-5 lg:p-6 gap-4 sm:gap-6 overflow-hidden">
        ...
        <section className="bg-sleek-bg overflow-y-auto custom-scrollbar p-3 sm:p-4 md:p-5 space-y-4">          {/* 4. Real-time Account Status Card (Single Row Dark Theme Layout) */}
